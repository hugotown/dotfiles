...
import type { DocInput } from "genai-core/document-processing/core";
...
type _DocSchemaShape = Static<typeof DocSchema>;
type _DocAssert = _DocSchemaShape extends Partial<DocInput> ? true : never;
const _docCheck: _DocAssert = true; void _docCheck;
