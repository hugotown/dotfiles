...
interface SearchArgs { query: string; model?: string; }
...
type _SearchSchemaShape = Static<typeof SearchSchema>;
type _SearchAssert = _SearchSchemaShape extends Partial<SearchArgs> ? true : never;
const _searchCheck: _SearchAssert = true; void _searchCheck;
