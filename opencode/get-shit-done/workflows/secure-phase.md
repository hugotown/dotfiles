...
```
Agent(
  prompt="Read /Users/hugoruiz/.config/opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/hugoruiz/.config/opencode/get-shit-done/templates/SECURITY.md`
