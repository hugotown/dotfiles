...
<template>
@/Users/hugoruiz/.config/opencode/get-shit-done/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@/Users/hugoruiz/.config/opencode/get-shit-done/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `/Users/hugoruiz/.config/opencode/get-shit-done/workflows/transition.md`.
...
- Follow @/Users/hugoruiz/.config/opencode/get-shit-done/workflows/diagnose-issues.md
