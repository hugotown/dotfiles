...
<required_reading>
@/Users/hugoruiz/.config/opencode/get-shit-done/references/ai-frameworks.md
@/Users/hugoruiz/.config/opencode/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/hugoruiz/.config/opencode/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/hugoruiz/.config/opencode/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/hugoruiz/.config/opencode/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/hugoruiz/.config/opencode/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/hugoruiz/.config/opencode/agents/gsd-eval-planner.md for instructions.
