...
```bash
INIT=$(node "/Users/hugoruiz/.config/opencode/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/hugoruiz/.config/opencode/get-shit-done/templates/spec.md.
