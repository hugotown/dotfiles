...
INSTALL_JS_GLOBAL="/Users/hugoruiz/.config/opencode/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/hugoruiz/.config/opencode/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
