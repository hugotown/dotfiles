...
<required_reading>
@/Users/hugoruiz/.config/opencode/get-shit-done/references/user-story-template.md
@/Users/hugoruiz/.config/opencode/get-shit-done/references/spidr-splitting.md
@/Users/hugoruiz/.config/opencode/get-shit-done/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@/Users/hugoruiz/.config/opencode/get-shit-done/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `question` calls. Each is free-text. After all three, assemble into the canonical sentence per `@/Users/hugoruiz/.config/opencode/get-shit-done/references/user-story-template.md`:
...
Run the SPIDR rules from `@/Users/hugoruiz/.config/opencode/get-shit-done/references/spidr-splitting.md`. Briefly:
