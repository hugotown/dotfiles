...
Key references:
- @/Users/hugoruiz/.config/opencode/get-shit-done/references/ui-brand.md (display patterns)
- @/Users/hugoruiz/.config/opencode/agents/gsd-user-profiler.md (profiler agent definition)
- @/Users/hugoruiz/.config/opencode/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/Users/hugoruiz/.config/opencode/get-shit-done/USER-PROFILE.md"
...
```bash
cp "/Users/hugoruiz/.config/opencode/get-shit-done/USER-PROFILE.md" "/Users/hugoruiz/.config/opencode/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /Users/hugoruiz/.config/opencode/get-shit-done/USER-PROFILE.md
...
Run session scan:
```bash
_GSD_SHIM_NAME="gsd-tools.cjs"; _GSD_RUNTIME_ROOT="${RUNTIME_DIR:-$(git rev-parse --show-toplevel 2>/dev/null || pwd)}"; GSD_TOOLS="${_GSD_RUNTIME_ROOT}/get-shit-done/bin/${_GSD_SHIM_NAME}"; if [ -f "$GSD_TOOLS" ]; then gsd_run() { node "$GSD_TOOLS" "$@"; }; elif [ -f "${_GSD_RUNTIME_ROOT}/.claude/get-shit-done/bin/${_GSD_SHIM_NAME}" ]; then GSD_TOOLS="${_GSD_RUNTIME_ROOT}/.claude/get-shit-done/bin/${_GSD_SHIM_NAME}"; gsd_run() { node "$GSD_TOOLS" "$@"; }; elif command -v gsd-tools >/dev/null 2>&1; then GSD_TOOLS="$(command -v gsd-tools)"; gsd_run() { "$GSD_TOOLS" "$@"; }; elif [ -f "/Users/hugoruiz/.config/opencode/get-shit-done/bin/${_GSD_SHIM_NAME}" ]; then GSD_TOOLS="/Users/hugoruiz/.config/opencode/get-shit-done/bin/${_GSD_SHIM_NAME}"; gsd_run() { node "$GSD_TOOLS" "$@"; }; else echo "ERROR: gsd-tools.cjs not found at $GSD_TOOLS and gsd-tools is not on PATH. Run: npx -y @opengsd/gsd-core@latest --claude --local" >&2; exit 1; fi
...
- The user-profiling reference doc at `/Users/hugoruiz/.config/opencode/get-shit-done/references/user-profiling.md`
...
Reference: @/Users/hugoruiz/.config/opencode/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to /Users/hugoruiz/.config/opencode/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global AGENTS.md" -- "Add profile to /Users/hugoruiz/.config/opencode/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /Users/hugoruiz/.config/opencode/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /Users/hugoruiz/.config/opencode/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to /Users/hugoruiz/.config/opencode/AGENTS.md"
...
```bash
BACKUP_PATH="/Users/hugoruiz/.config/opencode/USER-PROFILE.backup.md"
```
...
Your profile:    /Users/hugoruiz/.config/opencode/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /Users/hugoruiz/.config/opencode/skills/gsd-dev-preferences/SKILL.md
  ✓ AGENTS.md section       ./AGENTS.md
  ✓ Global AGENTS.md        /Users/hugoruiz/.config/opencode/AGENTS.md
```
