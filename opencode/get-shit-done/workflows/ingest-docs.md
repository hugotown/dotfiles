...
```bash
INIT=$(node "/Users/hugoruiz/.config/opencode/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/hugoruiz/.config/opencode/get-shit-done/bin/gsd-tools.cjs" commit \
