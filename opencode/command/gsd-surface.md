...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/hugoruiz/.config/opencode/.gsd-surface.json`
(sibling to `/Users/hugoruiz/.config/opencode/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/Users/hugoruiz/.config/opencode/skills/gsd-*/`.
...
(`~/.config/opencode`), NOT the skills sub-directory (`/Users/hugoruiz/.config/opencode/skills`).
...
`/Users/hugoruiz/.config/opencode/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/Users/hugoruiz/.config/opencode/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/Users/hugoruiz/.config/opencode/.gsd-surface.json`
Install profile marker: `/Users/hugoruiz/.config/opencode/.gsd-profile`
Skill dirs: `/Users/hugoruiz/.config/opencode/skills/gsd-*/`
Engine module: `/Users/hugoruiz/.config/opencode/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `/Users/hugoruiz/.config/opencode/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
