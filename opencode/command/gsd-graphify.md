...
**CJS-only (graphify):** `graphify` subcommands are not registered on `gsd-tools query`. Use `node /Users/hugoruiz/.config/opencode/get-shit-done/bin/gsd-tools.cjs graphify …` as documented in this command and in `docs/CLI-TOOLS.md`. Other tooling may still use `gsd-tools query` where a handler exists.
...
Knowledge graph is disabled. To activate:
  ...
  node /Users/hugoruiz/.config/opencode/get-shit-done/bin/gsd-tools.cjs config-set graphify.enabled true
...
```bash
node /Users/hugoruiz/.config/opencode/get-shit-done/bin/gsd-tools.cjs graphify query <term>
```
...
```bash
node /Users/hugoruiz/.config/opencode/get-shit-done/bin/gsd-tools.cjs graphify diff
```
...
```bash
node "/Users/hugoruiz/.config/opencode/get-shit-done/bin/gsd-tools.cjs" graphify build
```
...
graphify update . \
  ...
  && node "/Users/hugoruiz/.config/opencode/get-shit-done/bin/gsd-tools.cjs" graphify build snapshot \
  && node "/Users/hugoruiz/.config/opencode/get-shit-done/bin/gsd-tools.cjs" graphify status
```
