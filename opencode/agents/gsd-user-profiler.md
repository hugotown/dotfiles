...
<reference>
@/Users/hugoruiz/.config/opencode/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/hugoruiz/.config/opencode/get-shit-done/references/user-profiling.md` to load:
