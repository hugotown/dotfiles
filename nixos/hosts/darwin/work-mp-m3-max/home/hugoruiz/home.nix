{ config, inputs, pkgs, lib, hostname, ... }:
{
  ...
  programs.nushell = {
    ...
    # NOTE: extraEnv is deprecated in some home-manager versions
    # We use xdg.configFile to explicitly generate env.nu below
  };
...
EOF_NU_CONFIG
    ...
    # Nushell env.nu is managed by programs.nushell.extraEnv
    # DO NOT generate it here, or it will override the sops secrets configuration
    echo "  ✅ Nushell env.nu → Managed by programs.nushell.extraEnv (includes secrets)"
